...
const AdminHome = () => {
    ...
    //jehutu admin operation ti token shoho pathaite hobe abar kono vul response asle se unojagi action nite hobe sob axiosSecure kore dey easily
    ...
    return (
        <div>
            ...
            <div className="w-full m-4">
                <p className="test-3xl">Hi, {user?.displayName}</p>
            </div>

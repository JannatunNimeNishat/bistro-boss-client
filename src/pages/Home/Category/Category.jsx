    ...
    return (
        <>
            ...
            >
                <SwiperSlide >
                    <img src={slide1} alt="" />
                    <h3 className=" text-center -mt-16 text-4xl uppercase  text-white ">Salads</h3>
                </SwiperSlide>
                <SwiperSlide>
                    <img src={slide2} alt="" />
                    <h3 className=" text-center -mt-16 text-4xl uppercase  text-white ">Pizzas</h3>
                </SwiperSlide>
                <SwiperSlide>
                    <img src={slide3} alt="" />
                    <h3 className=" text-center -mt-16 text-4xl uppercase  text-white ">Soups</h3>
                </SwiperSlide>
                <SwiperSlide>
                    <img src={slide4} alt="" />
                    <h3 className=" text-center -mt-16 text-4xl uppercase  text-white ">Desserts</h3>
                </SwiperSlide>
                <SwiperSlide>
                    <img src={slide5} alt="" />
                    <h3 className=" text-center -mt-16 text-4xl uppercase  text-white ">Salads</h3>
